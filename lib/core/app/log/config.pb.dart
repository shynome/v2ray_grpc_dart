...
import '../../common/log/log.pbenum.dart' as $4;
...
class Config extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Config', package: const $pb.PackageName('v2ray.core.app.log'))
    ...
    ..e<$4.Severity>(2, 'errorLogLevel', $pb.PbFieldType.OE, $4.Severity.Unknown, $4.Severity.valueOf, $4.Severity.values)
    ..aOS(3, 'errorLogPath')
  ...
  $4.Severity get errorLogLevel => $_getN(1);
  set errorLogLevel($4.Severity v) { setField(2, v); }
