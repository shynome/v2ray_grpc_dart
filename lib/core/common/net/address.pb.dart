...
class IPOrDomain extends $pb.GeneratedMessage {
  ...
  IPOrDomain() : super();
  IPOrDomain.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  IPOrDomain.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static IPOrDomain create() => IPOrDomain();
