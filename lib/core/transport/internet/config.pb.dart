...
class TransportConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TransportConfig', package: const $pb.PackageName('v2ray.core.transport.internet'))
    ...
    ..a<$0.TypedMessage>(2, 'settings', $pb.PbFieldType.OM, $0.TypedMessage.getDefault, $0.TypedMessage.create)
    ..aOS(3, 'protocolName')
    ..hasRequiredFields = false
  ;

  TransportConfig() : super();
  TransportConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TransportConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static TransportConfig create() => TransportConfig();
  ...
  $0.TypedMessage get settings => $_getN(1);
  set settings($0.TypedMessage v) { setField(2, v); }
...
class StreamConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamConfig', package: const $pb.PackageName('v2ray.core.transport.internet'))
    ...
    ..aOS(3, 'securityType')
    ..pc<$0.TypedMessage>(4, 'securitySettings', $pb.PbFieldType.PM,$0.TypedMessage.create)
    ..aOS(5, 'protocolName')
  ...
  StreamConfig() : super();
  StreamConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  StreamConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  $pb.BuilderInfo get info_ => _i;
  static StreamConfig create() => StreamConfig();
  ...
  $core.List<$0.TypedMessage> get securitySettings => $_getList(3);
...
class ProxyConfig extends $pb.GeneratedMessage {
  ...
  ProxyConfig() : super();
  ProxyConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ProxyConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  $pb.BuilderInfo get info_ => _i;
  static ProxyConfig create() => ProxyConfig();
...
class SocketConfig extends $pb.GeneratedMessage {
  ...
  SocketConfig() : super();
  SocketConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SocketConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  $pb.BuilderInfo get info_ => _i;
  static SocketConfig create() => SocketConfig();
